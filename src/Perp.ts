...
import { AoMessage, AoMessageTags, lookForMessage } from './AoMessage';
        ...
        const summary: AccountSummary = {
            ...
            positions: new Map(
                Object.entries(summaryResponse.positions).map(([marketId, positionData]) => {
                    ...
                    if (market.account.id !== this.id) {
                        throw new Error('market.account !== `this`, should never happen');
                    }
...
type PerpOrderMarketCreateTagsParams = z.infer<typeof PerpOrderMarketCreateTagsSchema>;
